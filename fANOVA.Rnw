...
GR_NIRspektrum, echo=FALSE, out.height=1\linewidth, out.width=1\linewidth>>=
@
  \end{minipage}
  \hspace{0.1cm}
...
<<GR_canada, echo=FALSE, out.height=1\linewidth, out.width=1\linewidth>>=
@
  \end{minipage}
  \hspace{0.1cm}
  \begin{minipage}{0.48\textwidth}
  log-Periodogramm zum Laut \textit{aa}
<<GR_speech, echo=FALSE, out.height=1\linewidth, out.width=1\linewidth>>=
@
  \end{minipage}
\end{frame}
...
@
  \begin{minipage}{0.48\textwidth}
    \includegraphics[width = 1.1\linewidth, height = 1.1\linewidth]{kodiak_insel.png}
  \end{minipage} 
  \hspace{0.1cm}
  \begin{minipage}{0.48\textwidth}
    \begin{itemize}
...
\begin{itemize}  
  ...
  \item<3-> Keine Einfluss: Bucht und der Interaktion von Bucht $*$ Nahrung
...
@  
  \hspace{-0.1cm}   
  \begin{minipage}{0.48\textwidth}
<<GR_bspmort, echo=FALSE, out.height=1\linewidth, out.width=1\linewidth>>=
@
  \end{minipage} 
  \hspace{0.1cm}
  \begin{minipage}{0.48\textwidth}
...
@
  ...
  \hspace{0.1cm}
  \begin{minipage}{0.48\textwidth}
<<GR_res_org, echo=FALSE, out.height=1\linewidth, out.width=1\linewidth>>=
@
  \end{minipage}
\end{frame}
...
\frametitle{Resultat}
  \begin{minipage}{0.48\textwidth}
<<GR_res, echo=FALSE, out.height=1\linewidth, out.width=1\linewidth>>=
@
  \end{minipage} 
  \hspace{0.1cm}
  \begin{minipage}{0.48\textwidth}
    ...
    $\beta_1(s-1, s)$
    \item Sterblichkeitsrate steht in Beziehung zur Sterblichkeitsrate ein vom 
    vorigen Jahr Minus einem Jahr
 \end{itemize}
  \end{minipage}
\end{frame}
